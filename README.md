...
特别集成了**火山方舟（字节跳动）**，国内用户可以直连使用 Claude 模型，无需科学上网。

**Claude Chat** is an AI desktop chat app built with Electron. It supports multiple AI platforms, including **Volcano Ark (ByteDance)** for direct Claude access from China without a VPN.
...
|---|---|---|
| **火山方舟 (推荐)** | https://console.volcengine.com/ark/ | 国内直连，支持 Claude |
...
| 平台 | 支持模型 | 国内访问 |
|---|---|---|
| **火山方舟 (Volcano Ark)** | Claude Opus/Sonnet/Haiku, Doubao, DeepSeek | ✅ 直连 |
| **Anthropic** | Claude Opus 4.7, Sonnet 4.6, Haiku 4.5 | ❌ 需代理 |
| **DeepSeek** | DeepSeek-V3, DeepSeek-R1 | ✅ 直连 |
| **OpenAI** | GPT-4o, GPT-4.1 | ❌ 需代理 |
